...
HD_PWD='C:/Users/recep/ROM_LED/ROM_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_with_ROM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_with_ROM.tcl -notrace
