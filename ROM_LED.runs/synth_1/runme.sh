...
HD_PWD='C:/Users/recep/ROM_LED/ROM_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_with_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_with_ROM.tcl
